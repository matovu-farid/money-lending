...
export default function WeeklyLoansPage() {
  ...
  if (future) return <div className="space-y-2 p-4 md:p-6"><h1 className="text-2xl font-semibold">Weekly Loans</h1><p role="alert" className="text-sm text-destructive">Future weeks are not available.</p></div>
